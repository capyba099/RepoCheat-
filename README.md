...
**Прямая ссылка (v0.1.16):**

**[Скачать csdecomp.exe](https://github.com/capyba099/RepoCheat-/releases/download/v0.1.16/csdecomp.exe)**
...
2. Выберите последний релиз (сейчас **v0.1.16**)
...
После декомпиляции в начале `.cs` должна быть строка `// csdecomp: version=0.1.16` — так вы поймёте, что запущена новая версия.
